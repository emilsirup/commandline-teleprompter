...
alphabet_folder_path = Path("Title/Alphabet").resolve()
number_folder_path = Path("Title/Number").resolve()
symbol_folder_path = Path("Title/Symbol").resolve()
...
def arthonize(user_text):
    result = open("Title/Result.txt", 'w')
